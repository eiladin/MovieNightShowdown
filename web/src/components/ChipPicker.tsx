...
//
// Use it when there are several hundred options — TMDB's watch providers for a
// region. When there are three or four, use ChipToggleGroup: hiding four things
// behind a query only hides them, and a row of unselected pills reads as a row of
// selected chips, which is how this control came to be mistaken for the one below it.
//
...
export default function ChipPicker({
    ...
    const matches = useMemo(() => {
        if (trimmed === '') return []
        // Anything not already chosen, so the same thing cannot be offered twice.
